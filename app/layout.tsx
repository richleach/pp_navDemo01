              ...
              <SidebarBody>
                <SidebarSection>
                  ...
                  <Dropdown>
                    ...
                    >
                      ...
                      <DropdownItem href="/searchSample2">
                        <MagnifyingGlassCircleIcon />
                        <DropdownLabel className="font-bold">
                          Search All Events #2
                        </DropdownLabel>
                ...
                <SidebarSection className="max-lg:hidden">
                  <SidebarHeading className="text-slate-900 font-bold text-base">
                    <span className="font-bold text-base">Upcoming Events</span>
                  </SidebarHeading>
                  ...
                  <DropdownDivider className="mt-8" />
                  <SidebarHeading className="font-bold text-base">
